    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('titulo', models.CharField(choices=[('TVM', 'Trocar válvular do motor'), ('TO', 'Trocar óleo do motor'), ('B', 'Balanceamento')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ManyToManyField(to='servicos.categoriamanutencao')),
